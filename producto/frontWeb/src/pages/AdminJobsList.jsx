...
export default function AdminJobsList() {
  ...
  const loadItems = useCallback(() => {
    ...
    return listJobs(1, 50, filter, companyFilter.trim(), titleFilter.trim())
  ...
  }, [statusFilter, closingDueOn, companyFilter, titleFilter]);
        ...
        <div className="home-content">
          <div style={{ marginBottom: 16 }}>
            ...
            <div className="recruiter-jobs-list-header">
              <h2 className="recruiter-jobs-list-title">Gestionar ofertas</h2>
            ...
            <div className="admin-jobs-search-row">
              <label>
                Empresa
                <input
                  type="text"
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: 13, color: "#64748b" }}>
                      ...
                      {WORKLOAD_LABELS[job.workload] ?? job.workload} · Fecha
                      cierre: {formatJobDateDisplay(job.closing_date)}
                    </div>
                  </div>
